...
const Planner = ({ width, height, catalog, plugins, toolbarButtons, stateExtractor }) => {
    ...
    const handleViewARClick = () => {
        ...
        axios.post('http://localhost:9000/process_image', formData)
            .then(response => {
        ...
        <div>
            {
                !hide ? (<React.Fragment>
                    <header>
                    <h2> <img src="https://toppng.com/uploads/preview/white-house-clipart-big-house-house-icon-11562911433rmakb3jx7h.png" /> 3D Home Space AR</h2>
                    </header>
